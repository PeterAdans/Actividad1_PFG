...
public class Excursion implements Serializable {
	...
	public Excursion(int idExcursion, String descripcion, String origen, String destino, int duracion, String estado,
			String destacado, int aforoMaximo, int minimoAsistentes, double precioUnitario, String imagen,
			LocalDate fechaExcursion, LocalDate fechaAlta) {
		super();
	...
	public String toString() {
		return "Excursion [idExcursion=" + idExcursion + ", descripcion=" + descripcion + ", origen=" + origen
				+ ", destino=" + destino + ", duracion=" + duracion + ", estado=" + estado + ", destacado=" + destacado
				+ ", aforoMaximo=" + aforoMaximo + ", minimoAsistentes=" + minimoAsistentes + ", precioUnitario="
				+ precioUnitario + ", imagen=" + imagen + ", fechaExcursion=" + fechaExcursion + ", fechaAlta="
				+ fechaAlta + "]";
	}
